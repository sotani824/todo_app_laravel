<template>
    <div class="container-fruid" style="overflow-y: scroll;">
        ...
        <div v-for="(todo, key, index) in todos" :key="index">
            <div class="d-flex justify-content-center m-3">
                <div class="card" style="width: 18rem;" v-if="todo.done == 0">
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            Tag：<span
                                v-for="(key, index) in todo.tags"
                                :key="index"
                                ><small class="mr-1">{{
                                    todo.tags[index].title
                                }}</small></span
                            >
                        </div>
                    ...
                    <div
                        class="btn-group position-absolute dropdown"
                    ...
                    >
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div
                                ...
                                v-on:click="doneTodoUpdate(todo)"
                                v-if="todo.done == 0"
                            >
                                Done
                            </div>
                            ...
                            <div
                                class="text-center"
                                data-toggle="modal"
                                :data-target="'#todoModal' + goalId + todo.id"
                                v-on:click="content = todo.content"
                            >
                                Edit
                            </div>
                            <div
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button
                                ...
                                class="btn btn-secondary"
                                data-dismiss="modal"
                                v-on:click="editTodoContent(todo)"
                            >
                                Submit
                            </button>
                        </div>
            ...
            <div
                class="modal fade"
                :id="'todoSortModal' + goalId + todo.id"
                tabindex="-1"
                role="dialog"
                aria-labelledby="exampleModalLabel"
                aria-hidden="true"
...
export default {
    ...
    methods: {
        getAllTodos: function() {
            axios.get(`/goals/${this.goalId}/todos`).then(
                response => {
        ...
        addTodoTag: function(todoId, tagId) {
            ...
            axios
                .post(`/goals/${this.goalId}/todos/${todoId}/tags/${tagId}`)
                .then(
                    response => {
                        this.todos.length = 0;
                        for (let i = 0; i < response.data.length; i++) {
        ...
        doneTodoUpdate: function(todo) {
            ...
            axios
                .post(`/goals/${this.goalId}/todos/${todo.id}`, {
        ...
        editTodoContent: function(todo) {
            ...
            axios.defaults.headers["content-type"] = "application/json";
            axios
                .post(`/goals/${todo.goal_id}/todos/${todo.id}`, {
                    content: this.content,
                    position: todo.position,
                    done: todo.done,
                    _method: "patch"
        ...
        sortTodo: function(todo) {
            ...
            axios
                .post(`/goals/${this.goalId}/todos/${todo.id}/sort`, {
